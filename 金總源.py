...
def select_image():
    ...
    if file_path:
        ...
        attachment_label.config(
            text=f"附件數量: {len(attachment_paths)}", font=("Arial", 12, "bold")
        )
...
def main():
    ...
    tk.Label(root, text="工號：", font=("Arial", 12)).grid(
    ...
    tk.Label(root, text="信箱：", font=("Arial", 12)).grid(
    ...
    tk.Label(root, text="電話(分機)：", font=("Arial", 12)).grid(
    ...
    tk.Label(root, text="Anydesk號碼：", font=("Arial", 12)).grid(
    ...
    tk.Label(root, text="問題描述：", font=("Arial", 12)).grid(
    ...
    tk.Button(
        root, text="畫面截圖", command=capture_screenshot, font=("Arial", 12)
    ...
    submit_button = tk.Button(
        root, text="提交報修", command=submit_report, font=("Arial", 14, "bold")
    )
